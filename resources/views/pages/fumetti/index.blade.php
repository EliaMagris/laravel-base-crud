...
@section('main-content')
    ...
    <div class="py-3">
        <button type="button" class="btn btn-primary "><a class="text-white text-decoration-none" href="{{ route('fumetti.create') }}">Crea dei fumetti</a></button>
            ...
            @foreach ($comics as $elem)
                <div class="col-3">
                    ...
                    <div class="card h-100" data-bs-theme="dark" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <a href="{{ route('fumetti.show', $elem->id) }}" class="card-link">see info</a>
                        </div>
